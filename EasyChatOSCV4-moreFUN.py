...
# ====================================================================
# ✨ ✨ ✨ 核心封装：绝对坐标钉死防挤压、0.1 位高精倒计时 Toast 封装
# ====================================================================
class ToastManager:
    active_toasts = []  
    lock = threading.Lock()
...
# ====================================================================
# 🚀 异步高频线程流：控制独立高频参数发送（心率、眼追踪、高级陀螺控制器）
# ====================================================================
...
class VrcConfigMenu:
    def __init__(self, root):
        ...
        # 2. 眼部追踪虚拟摇杆面板
        frame_eye = tk.LabelFrame(more_scroll_container, text="👁️ OSC 眼部追踪控制摇杆 (绝对记忆位置)", bg="#1a1a1a", fg="#4ccdec", font=ui_font, padx=10, pady=4)
        ...
        # 4. 通知测试
        btn_test = tk.Button(more_scroll_container, text="测试大文本 Toast 边缘防覆盖通知", font=ui_font, bg="#2d2d2d", fg="#4ccdec", 
    ...
    def update_joystick_pos(self, event):
        ...
        # 换算至 VRChat 标准眼轴：-1.0 到 1.0 (反转 Y 轴匹配空间朝向)
